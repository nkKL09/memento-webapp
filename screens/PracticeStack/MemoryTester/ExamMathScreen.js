// 5 примеров (+, −, ×, ÷), ответ 10–99, перед вводом ответов экзамена
...
export default function ExamMathScreen() {
  ...
  if (!sequence.length || startTime == null) {
  ...
  const onNext = () => {
    ...
    navigation.navigate('ExamInput', { sequence, moduleId, moduleName, count, startTime });
  };
